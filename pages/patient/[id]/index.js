    ...
    <>
      ...
      <Layout>
        <section className="container">
          <h3 className="mb-4">
            <strong>
              {datos.nombre && datos.nombre.toUpperCase()}-{datos.edad} AÑOS
            </strong>
          </h3>
          <div className="row">
            <div className="col">
              ...
              <p className="pt-2 h5">
                <strong>Fecha Ultima Medición</strong>
              </p>
          ...
          <div className="row">
            ...
            <div className="col">
              <p className="pt-2 h5">
                <strong>Fecha Inicial de Consulta:</strong>
              </p>
              <input type="date" className="form-control" />
            </div>
            <div className="col">
              <p className="pt-2 h5">
                <strong>Fecha Final de Consulta:</strong>
              </p>
              <input type="date" className="form-control" />
            </div>
            <div className="col">
